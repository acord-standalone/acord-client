...
async function buildExtension(target, files) {
    const entries = {
        "dist/Acord.js": await readFile("dist/browser/extension.js"),
        "dist/Acord.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Acord.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/Acord.user.js", cssRuntime);
});
