...
export const ACORD_GITHUB_REPO = "acord-standalone/acord-client";
export const ACORD_GITHUB_REPO_URL = `https://github.com/${ACORD_GITHUB_REPO}`;
...
export const getRepo = async () => ACORD_GITHUB_REPO_URL;
