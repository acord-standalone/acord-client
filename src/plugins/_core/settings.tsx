...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Acord settings section",
        options: [
...
export default definePlugin({
    ...
    getInfoRows() {
        ...
        const rows = [`Acord ${gitHashShort}${getVersionInfo()}`];
