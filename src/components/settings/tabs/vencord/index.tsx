...
const SHIGGY_DONATE_IMAGE = "https://raw.githubusercontent.com/acord-standalone/assets/refs/heads/main/logo/acord-circle.png";
        ...
        <SettingsTab>
            {(isEquicordDonor(user?.id) || isVencordDonor(user?.id)) ? (
                <SpecialCard
                    ...
                    description={
                        isEquicordDonor(user?.id) && isVencordDonor(user?.id)
                            ? "All Vencord users can see your Vencord donor badge, and Acord users can see your Acord donor badge. To change your Vencord donor badge, contact @vending.machine. For your Acord donor badge, make a ticket in Acord's server."
                            : isVencordDonor(user?.id)
                                ? "All Vencord users can see your badge! You can manage your perks by messaging @vending.machine."
                                : "All Acord users can see your badge! You can manage your perks by making a ticket in Acord's server."
                    }
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of Acord by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Acord you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Acord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
...
export default wrapTab(EquicordSettings, "Acord Settings");
